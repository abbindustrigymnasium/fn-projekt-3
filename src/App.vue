  ...
  <div id="js-view">
    <div class="page">
      <div class="cover parallax has-dark-cover">
        <div class="cover__logo"><img src="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg" width="auto"></div>
        <div class="parallax__container">
          <video src="https://github.com/abbguslof/MazeGame/raw/main/images/VideoForFn.mp4" autoplay="" muted="" loop="" playsinline=""></video>
          <button type="button" class="arrow arrow--down"><svg>
      ...
      <div class="wrapper">
        <div class="about">
          <p>Information om vårat projekt. bla bla bla.
